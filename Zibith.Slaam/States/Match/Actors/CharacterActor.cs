        ...
        private void GetPowerup(Tile currtile, MatchState gameScreenState)
        {
            ...
            switch (currtile.CurrentPowerupType)
            {
                case PowerupType.SpeedUp:
                    CurrentPowerup = new SpeedUp(this, ServiceLocator.GetService<IResources>(), _frameTimeService);
                    break;

                case PowerupType.SpeedDown:
                    CurrentPowerup = new SpeedDown(PlayerIndex, ServiceLocator.GetService<IResources>(), _frameTimeService);
                    break;

                case PowerupType.Inversion:
                    CurrentPowerup = new Inversion(PlayerIndex, ServiceLocator.GetService<IResources>(), _frameTimeService);
                    break;

                case PowerupType.Slaam:
                    CurrentPowerup = new SlaamPowerup(this, PlayerIndex, ServiceLocator.GetService<IResources>());
                    break;
