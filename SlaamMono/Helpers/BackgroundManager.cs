...
namespace SlaamMono.Helpers
{
    ...
    static class BackgroundManager
    {
        ...
        public static void Draw(SpriteBatch batch)
        {
            ...
            {
                batch.Draw(x_Resources.Background.Texture, new Rectangle(0, 0, GameGlobals.DRAWING_GAME_WIDTH, GameGlobals.DRAWING_GAME_HEIGHT), Color.White);
            }
            else if (CurrentType == BackgroundType.Menu)
            {
                batch.Draw(x_Resources.Background.Texture, new Rectangle(0, 0, GameGlobals.DRAWING_GAME_WIDTH, GameGlobals.DRAWING_GAME_HEIGHT), Color.White);
            ...
            {
                batch.Draw(x_Resources.BattleBG.Texture, new Vector2(0, BGOffset - x_Resources.BattleBG.Height), Color.White);
                batch.Draw(x_Resources.BattleBG.Texture, new Vector2(0, BGOffset), Color.White);
            }
        }
