...
#endif
                ResourceManager.DrawText(DialogStrings.CleanMapName(ValidBoards[save]), new Vector2(27, 225), ResourceManager.SegoeUIx32pt, FontAlignment.Left, Color.White, true);
            }
        }
