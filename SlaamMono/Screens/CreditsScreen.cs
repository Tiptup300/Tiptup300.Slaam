    ...
    public class CreditsScreen : IScreen
    {
        ...
        public void Draw(SpriteBatch batch)
        {
            ...
            for (int CurrentCredit = 0; CurrentCredit < CreditsListings.Count; CurrentCredit++)
            {
                ...
                {
                    TextManager.Instance.AddTextToRender(CreditsListings[CurrentCredit].Name, new Vector2(TextCoords.X, TextCoords.Y + Offset), ResourceManager.SegoeUIx32pt, MainCreditColor, TextAlignment.Default, false);
                }
                ...
                for (int x = 0; x < CreditsListings[CurrentCredit].Credits.Count; x++)
                {
                    ...
                    {
                        TextManager.Instance.AddTextToRender(CreditsListings[CurrentCredit].Credits[x], new Vector2(TextCoords.X + 10, TextCoords.Y + Offset), ResourceManager.SegoeUIx14pt, SubCreditColor, TextAlignment.Default, false);
                    }
