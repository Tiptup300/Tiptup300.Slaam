...
namespace SlaamMono.SubClasses
{
    ...
    public class GameScreenTimer
    {
        ...
        {
            batch.Draw(ResourceManager.GetTexture("TopGameBoard").Texture, new Vector2(1280 - ResourceManager.GetTexture("TopGameBoard").Width + Position.X, 0), Color.White);
            TextManager.Instance.AddTextToRender(ZeroImpress(GameMatchTime.Minutes), new Vector2(1181.5f + Position.X, 64), ResourceManager.GetFont("SegoeUIx14pt"), Color.Black, TextAlignment.Centered, false);
            TextManager.Instance.AddTextToRender(ZeroImpress(GameMatchTime.Seconds), new Vector2(1219.5f + Position.X, 64), ResourceManager.GetFont("SegoeUIx14pt"), Color.Black, TextAlignment.Centered, false);
            TextManager.Instance.AddTextToRender(ZeroImpress(GameMatchTime.Milliseconds), new Vector2(1257.5f + Position.X, 64), ResourceManager.GetFont("SegoeUIx14pt"), Color.Black, TextAlignment.Centered, false);
            ...
            {
                TextManager.Instance.AddTextToRender("Time Elapsed", new Vector2(Position.X + 1270, 30), ResourceManager.GetFont("SegoeUIx32pt"), Color.White, TextAlignment.Right, true);
            }
            else if (ParentGameScreen.ThisGameType == GameType.TimedSpree)
            {
                TextManager.Instance.AddTextToRender("Time Remaining", new Vector2(Position.X + 1270, 30), ResourceManager.GetFont("SegoeUIx32pt"), Color.White, TextAlignment.Right, true);
            }
        }
