...
namespace SlaamMono.SubClasses
{
    ...
    public class GameScreenScoreboard
    {
        ...
        public void Draw(SpriteBatch batch)
        {
            ...
            ResourceManager.DrawString(Character.GetProfile().Name, new Vector2(8 + Position.X, 18 + Position.Y), ResourceManager.SegoeUIx14pt, FontAlignment.Left, Color.White, true);
            ResourceManager.DrawString(Character.Kills.ToString(), new Vector2(35 + Position.X, 68 + Position.Y), ResourceManager.SegoeUIx14pt, FontAlignment.Center, Color.White, true);
            if (CurrentGametype == GameType.Classic || CurrentGametype == GameType.Survival)
                ResourceManager.DrawString(Character.Lives.ToString(), new Vector2(73 + Position.X, 68 + Position.Y), ResourceManager.SegoeUIx14pt, FontAlignment.Center, Color.White, true);
            else if (CurrentGametype == GameType.Spree || CurrentGametype == GameType.TimedSpree)
                ResourceManager.DrawString("inf.", new Vector2(73 + Position.X, 68 + Position.Y), ResourceManager.SegoeUIx14pt, FontAlignment.Center, Color.White, true);
    ...
    public class GameScreenTimer
    {
        ...
        public void Draw(SpriteBatch batch)
        {
            ...
            ResourceManager.DrawString(ZeroImpress(GameMatchTime.Minutes), new Vector2(1181.5f + Position.X, 64), ResourceManager.SegoeUIx14pt, FontAlignment.Center, Color.Black, false);
            ResourceManager.DrawString(ZeroImpress(GameMatchTime.Seconds), new Vector2(1219.5f + Position.X, 64), ResourceManager.SegoeUIx14pt, FontAlignment.Center, Color.Black, false);
            ResourceManager.DrawString(ZeroImpress(GameMatchTime.Milliseconds), new Vector2(1257.5f + Position.X, 64), ResourceManager.SegoeUIx14pt, FontAlignment.Center, Color.Black, false);
            ...
            {
                ResourceManager.DrawString("Time Elapsed", new Vector2(Position.X + 1270, 30), ResourceManager.SegoeUIx32pt, FontAlignment.Right, Color.White, true);
            }
            else if (ParentGameScreen.ThisGameType == GameType.TimedSpree)
            {
                ResourceManager.DrawString("Time Remaining", new Vector2(Position.X + 1270, 30), ResourceManager.SegoeUIx32pt, FontAlignment.Right, Color.White, true);
            }
        }
