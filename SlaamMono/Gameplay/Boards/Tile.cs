    ...
    public class Tile
    {
        ...
        public static void updateState(GameScreenState gameScreenState, TileState tileState)
        {
            if (tileState.CurrentTileCondition == TileCondition.RespawnPoint)
            {
                ...
                tileState.FallSpeed.Update(FrameRateDirector.Instance.GetLatestFrame().MovementFactorTimeSpan);
            ...
            {
                tileState.FadeThrottle.Update(FrameRateDirector.Instance.GetLatestFrame().MovementFactorTimeSpan);
            ...
            {
                tileState.ReappearSpeed.Update(FrameRateDirector.Instance.GetLatestFrame().MovementFactorTimeSpan);
