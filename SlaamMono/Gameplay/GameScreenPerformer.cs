...
namespace SlaamMono.Gameplay
{
    public class GameScreenPerformer : IStatePerformer
    {
        ...
        public void InitializeState()
        {
            ...
            _state.ReadySetGoThrottle.Update(FrameRateDirector.Instance.GetLatestFrame().MovementFactorTimeSpan);
        ...
        public void survival_Perform()
        {
            ...
            {
                _state.SurvivalState.TimeToAddBot.Update(FrameRateDirector.Instance.GetLatestFrame().MovementFactorTimeSpan);
        ...
        private void updatePlayingGameState()
        {
            ...
            _state.PowerupTime.Update(FrameRateDirector.Instance.GetLatestFrame().MovementFactorTimeSpan);
        ...
        {
            _state.Boardpos = new Vector2(_state.Boardpos.X, _state.Boardpos.Y + FrameRateDirector.Instance.GetLatestFrame().MovementFactor * (10f / 100f));
