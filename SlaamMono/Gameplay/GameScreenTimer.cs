...
namespace SlaamMono.Gameplay
{
    ...
    public class GameScreenTimer
    {
        ...
        public GameScreenTimer(Vector2 position, GameScreen parentgamescreen, IResources resources)
        {
            ...
            setGameMatchTime(_parentGameScreen.x_ToRemove__ThisGameType);
        ...
        public void Update(bool StartTiming)
        {
            ...
            if (StartTiming)
            {
                if (TimeRemaining > TimeSpan.Zero || _parentGameScreen.x_ToRemove__ThisGameType == GameType.Spree || _parentGameScreen.x_ToRemove__ThisGameType == GameType.Classic || _parentGameScreen.x_ToRemove__ThisGameType == GameType.Survival)
                {
                ...
                if (_parentGameScreen.x_ToRemove__ThisGameType == GameType.TimedSpree)
                {
        ...
        public void Draw(SpriteBatch batch)
        {
            ...
            if (_parentGameScreen.x_ToRemove__ThisGameType == GameType.Classic || _parentGameScreen.x_ToRemove__ThisGameType == GameType.Spree || _parentGameScreen.x_ToRemove__ThisGameType == GameType.Survival)
            {
            ...
            else if (_parentGameScreen.x_ToRemove__ThisGameType == GameType.TimedSpree)
            {
